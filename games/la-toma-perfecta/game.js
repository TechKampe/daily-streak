...
function showRound() {
  ...
  btn.style.cssText = 'position:absolute;bottom:calc(50px + env(safe-area-inset-bottom, 0px));left:50%;transform:translateX(-50%);max-width:220px;font-size:15px;padding:12px 20px;z-index:150;';
